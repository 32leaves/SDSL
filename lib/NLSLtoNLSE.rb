  ...
  module Compiler
    ...
    BUILTIN_FUNCTIONS = [
      ...
      [ :vec2, :vec3, :vec4 ].map {|t| [
        ...
        _mkbfunc("clamp", [ t, t, t ], t),
        _mkbfunc("abs"  , [ t ], t),
        _mkbfunc("min"  , [ t, :float ], t),
        _mkbfunc("min"  , [ t, t ], t),
        _mkbfunc("max"  , [ t, :float ], t),
        _mkbfunc("max"  , [ t, t ], t),
      ]}
    ].flatten
    ...
    OPERATIONS = {
      ...
      "- vec4 float" => NLSE::VectorSubScalar,
      "- vec3 vec3" => NLSE::VectorSubVector,
      "- vec3 float" => NLSE::VectorSubScalar,
      "- vec2 vec2" => NLSE::VectorSubVector,
      "- vec2 float" => NLSE::VectorSubScalar,
